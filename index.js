...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-XBTS/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-XBTS -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-XBTS -o bitcore-lib-XBTS.js';
    }
